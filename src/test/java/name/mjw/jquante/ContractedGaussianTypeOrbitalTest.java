...
public class ContractedGaussianTypeOrbitalTest {
	...
	public void testSTO_3G_1S_H() {
		...
		PrimitiveGaussianTypeOrbital pgto1 = new PrimitiveGaussianTypeOrbital(3.42525091);
		PrimitiveGaussianTypeOrbital pgto2 = new PrimitiveGaussianTypeOrbital(0.62391373);
		PrimitiveGaussianTypeOrbital pgto3 = new PrimitiveGaussianTypeOrbital(0.16885540);
