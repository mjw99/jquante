...
class HartreeFockForceNumericalTest {
    ...
    private double scfEnergy(Molecule mol) {
        return scfEnergy(mol, "sto-3g");
    }

    private double scfEnergy(Molecule mol, String basis) {
        BasisSetLibrary bsl;
        try {
    ...
    // -----------------------------------------------------------------------
    // H2 / 3-21G — split-valence basis (larger than STO-3G)
    // -----------------------------------------------------------------------

    @Test
    void h2H1AnalyticMatchesNumerical321G() {
        Molecule molP = new MoleculeImpl("h2p");
        molP.addAtom(new Atom("H", new Vector3D( H_ANG, 0, 0)));
        molP.addAtom(new Atom("H", new Vector3D(0.74,   0, 0)));
        ...
        double numGrad  = (scfEnergy(molP, "3-21g") - scfEnergy(molM, "3-21g")) / (2.0 * H_BOHR);
        double numForce = -numGrad;

        Molecule mol0 = new MoleculeImpl("h2");
        mol0.addAtom(new Atom("H", new Vector3D(0.0, 0, 0)));
        mol0.addAtom(new Atom("H", new Vector3D(0.74, 0, 0)));
        SCFMethod scfm = runSCF(mol0, "3-21g");
        double analyticForce = new HartreeFockForce().computeForce(0, scfm).getX();

        System.out.printf("H2/3-21G H1 force: numeric=%.6f  analytic=%.6f%n", numForce, analyticForce);
        assertEquals(numForce, analyticForce, 1e-3);
    }

    @Test
    void h2H2AnalyticMatchesNumerical321G() {
        Molecule molP = new MoleculeImpl("h2p");
        molP.addAtom(new Atom("H", new Vector3D(0,          0, 0)));
        molP.addAtom(new Atom("H", new Vector3D(0.74+H_ANG, 0, 0)));
        ...
        System.out.printf("H2/3-21G H2 force: numeric=%.6f  analytic=%.6f%n", numForce, analyticForce);
        assertEquals(numForce, analyticForce, 1e-3);
    }
    ...
    @Test
    void waterOzAnalyticMatchesNumerical321G() {
        Molecule molP = new MoleculeImpl("waterP");
        molP.addAtom(new Atom("O", new Vector3D(0, 0,  0.119748 + H_ANG)));
        molP.addAtom(new Atom("H", new Vector3D(0,  0.761561, -0.478993)));
        molP.addAtom(new Atom("H", new Vector3D(0, -0.761561, -0.478993)));
        ...
        System.out.printf("Water/3-21G O z force: numeric=%.6f  analytic=%.6f%n", numForce, analyticForce);
        assertEquals(numForce, analyticForce, 1e-3);
    }

    @Test
    void waterH1yAnalyticMatchesNumerical321G() {
        Molecule molP = new MoleculeImpl("waterP");
        molP.addAtom(new Atom("O", new Vector3D(0, 0, 0.119748)));
        molP.addAtom(new Atom("H", new Vector3D(0, 0.761561 + H_ANG, -0.478993)));
        molP.addAtom(new Atom("H", new Vector3D(0, -0.761561, -0.478993)));
        ...
        System.out.printf("Water/3-21G H1 y force: numeric=%.6f  analytic=%.6f%n", numForce, analyticForce);
        assertEquals(numForce, analyticForce, 1e-3);
    }

    // -----------------------------------------------------------------------
    // H2 / 6-31G** — split-valence + polarization (largest available basis)
    // -----------------------------------------------------------------------

    @Test
    void h2H1AnalyticMatchesNumerical631Gss() {
        Molecule molP = new MoleculeImpl("h2p");
        molP.addAtom(new Atom("H", new Vector3D( H_ANG, 0, 0)));
        molP.addAtom(new Atom("H", new Vector3D(0.74,   0, 0)));
        ...
        double numGrad  = (scfEnergy(molP, "6-31gss") - scfEnergy(molM, "6-31gss")) / (2.0 * H_BOHR);
        double numForce = -numGrad;

        Molecule mol0 = new MoleculeImpl("h2");
        mol0.addAtom(new Atom("H", new Vector3D(0.0, 0, 0)));
        mol0.addAtom(new Atom("H", new Vector3D(0.74, 0, 0)));
        SCFMethod scfm = runSCF(mol0, "6-31gss");
        double analyticForce = new HartreeFockForce().computeForce(0, scfm).getX();

        System.out.printf("H2/6-31G** H1 force: numeric=%.6f  analytic=%.6f%n", numForce, analyticForce);
        assertEquals(numForce, analyticForce, 1e-3);
    }

    @Test
    void waterOzAnalyticMatchesNumerical631Gss() {
        Molecule molP = new MoleculeImpl("waterP");
        molP.addAtom(new Atom("O", new Vector3D(0, 0,  0.119748 + H_ANG)));
        molP.addAtom(new Atom("H", new Vector3D(0,  0.761561, -0.478993)));
        molP.addAtom(new Atom("H", new Vector3D(0, -0.761561, -0.478993)));
        ...
        System.out.printf("Water/6-31G** O z force: numeric=%.6f  analytic=%.6f%n", numForce, analyticForce);
        assertEquals(numForce, analyticForce, 1e-3);
    }

    @Test
    void waterH1yAnalyticMatchesNumerical631Gss() {
        Molecule molP = new MoleculeImpl("waterP");
        molP.addAtom(new Atom("O", new Vector3D(0, 0, 0.119748)));
        molP.addAtom(new Atom("H", new Vector3D(0, 0.761561 + H_ANG, -0.478993)));
        molP.addAtom(new Atom("H", new Vector3D(0, -0.761561, -0.478993)));
        ...
        System.out.printf("Water/6-31G** H1 y force: numeric=%.6f  analytic=%.6f%n", numForce, analyticForce);
        assertEquals(numForce, analyticForce, 1e-3);
    }
}
