...
/**
 * This interface defines how an implementation that reads various molecule file
 * formats should behave. We use an interface driven approach so as to reduce
 * the amount of memory any unwanted class may take. Refer to class
...
public interface MoleculeFileReader {
	...
	/**
	 * This method returns the type or class of file formats being read. For
	 * e.g. if the implementation class reads XYZ files then this method may
	 * return a string like 'XYZ File format'.
	 * 
	 * @return A string indicating the type or class of molecule file formats,
	 *         whose reading is supported. The string returned should be treated
	 *         as case insensitive.
	 */
	 ...
	 * 
	 * @param fileName
	 *            The complete path of the file to be read.
	 * @return raw instance of the Molecule object.
	 * @throws IOException
	 *             Indicating an error in the input stream / file.
	 */
	 ...
	 * 
	 * @param file
	 *            An instance of the file object specifing the file to be read.
	 * @return raw instance of the Molecule object.
	 * @throws IOException
	 *             Indicating an error in the input stream / file.
	 */
	 ...
	 * 
	 * @param inputStream
	 *            General instance of input stream from where to read the
	 *            molecule data.
	 ...
	 * 
	 * @param reader
	 *            instance of reader from where to read the molecule data.
	 * @return An instance of raw Molecule object.
	 * @throws IOException
	 *             Indicating an error in the input stream / file.
	 */
	 ...
	 *            instance of reader from where to read the molecule data.
	 * @param readDeep
	 *            read deep into the file, including additional information
	 * @return An instance of raw Molecule object.
	 * @throws IOException
	 *             Indicating an error in the input stream / file.
	 */
