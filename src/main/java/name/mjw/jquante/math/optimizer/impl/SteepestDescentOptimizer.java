...
public class SteepestDescentOptimizer extends AbstractOptimizer {
	 ...
	 * @param stepSize
	 *            the normal step scale to use
	 * @param maxStep
	 *            the maximum step distance for one iteration
	 */
	public SteepestDescentOptimizer(OptimizerFunction function,
			double stepSize, double maxStep) {
		super(function);
