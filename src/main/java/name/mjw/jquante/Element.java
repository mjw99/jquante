...
public class Element {
	...
	private static final String[] Name = { "dummy", "hydrogen", "helium",
			...
			"tellerium", "iodine", "xenon", "cesium", "barium", "lanthanum",
	...
	private static final double[] Mass = { 0.00, 1.0008, 4.0026, 6.941, 9.0122,
			...
			58.6934, 63.546, 65.39, 69.723, 72.61, 74.9216, 78.96, 79.904,
			83.80, 85.4678, 87.62, 88.90686, 91.224, 92.90638, 95.94, 98,
			101.07, 102.90550, 106.42, 107.8682, 112.411, 114.818, 118.710,
			121.760, 127.60, 126.90447, 131.29, 132.90545, 137.327, 138.9055,
