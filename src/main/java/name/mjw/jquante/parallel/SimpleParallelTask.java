 ...
 * system.
 * 
 * Interface declaring how a simple parallel task should be defined. This
 * parallel task as of now represents a thread (s) running in a true shared
 * meory environmnet, it future it may be extened to distributed memory systems.
 * 
 * @author V.Ganesh
...
public interface SimpleParallelTask extends Runnable {
	...
	/**
	 * Initialize the task and return a new instance of this task. It is
	 * required that a new instance is returned at every call as each of these
	 * tasks will be run on a saparate thread.
	 * 
	 * @param startItem
	 *            index of starting item to be processed
	 * @param endItem
	 *            index of last item to be processed
